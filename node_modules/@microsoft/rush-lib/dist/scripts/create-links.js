...
function main() {
    ...
    const deployMetadataPath = path__WEBPACK_IMPORTED_MODULE_1__.join(targetRootFolder, 'deploy-metadata.json');
    if (!fs__WEBPACK_IMPORTED_MODULE_0__.existsSync(deployMetadataPath)) {
        throw new Error('Input file not found: ' + deployMetadataPath);
    }
    const deployMetadataJson = fs__WEBPACK_IMPORTED_MODULE_0__.readFileSync(deployMetadataPath).toString();
