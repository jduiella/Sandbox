...
/* harmony import */ var _api_ChangeManagement__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../api/ChangeManagement */ 780924);
/* harmony import */ var _api_RushConfiguration__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../api/RushConfiguration */ 126002);
/* harmony import */ var _PublishUtilities__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./PublishUtilities */ 189294);
/* harmony import */ var _ChangeManager__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ChangeManager */ 121467);
/* harmony import */ var _DependencySpecifier__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./DependencySpecifier */ 68654);
...
const lodash = _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_2__.Import.lazy('lodash', require);
class VersionManager {
    ...
    _updateProjectDependencies(dependencies, changes, clonedProject, rushProject, projectVersionChanged) {
        ...
        this.updatedProjects.forEach((updatedDependentProject, updatedDependentProjectName) => {
            if (dependencies[updatedDependentProjectName]) {
                ...
                const newDependencyVersion = _PublishUtilities__WEBPACK_IMPORTED_MODULE_7__.PublishUtilities.getNewDependencyVersion(dependencies, updatedDependentProjectName, updatedDependentProject.version);
    ...
    _trackDependencyChange(changes, clonedProject, projectVersionChanged, updatedDependentProject, oldDependencyVersion, newDependencyVersion) {
        const oldSpecifier = new _DependencySpecifier__WEBPACK_IMPORTED_MODULE_8__.DependencySpecifier(updatedDependentProject.name, oldDependencyVersion);
        if (!semver__WEBPACK_IMPORTED_MODULE_1__.satisfies(updatedDependentProject.version, oldSpecifier.versionSpecifier) &&
            ...
            this._addChange(changes, {
                changeType: _api_ChangeManagement__WEBPACK_IMPORTED_MODULE_9__.ChangeType.patch,
        ...
        if (!this._isPrerelease(updatedDependentProject.version) && !this._isPrerelease(clonedProject.version)) {
            this._addChange(changes, {
                changeType: _api_ChangeManagement__WEBPACK_IMPORTED_MODULE_9__.ChangeType.dependency,
    ...
    _createChangeInfo(newPackageJson, rushProject) {
        return {
            changeType: _api_ChangeManagement__WEBPACK_IMPORTED_MODULE_9__.ChangeType.none,
