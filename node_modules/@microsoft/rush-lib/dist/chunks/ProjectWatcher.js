...
/* harmony import */ var events__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! events */ 582361);
...
/* harmony import */ var _Git__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Git */ 668229);
/* harmony import */ var _ProjectChangeAnalyzer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ProjectChangeAnalyzer */ 311605);
...
class ProjectWatcher {
    constructor(options) {
        ...
        const gitPath = new _Git__WEBPACK_IMPORTED_MODULE_5__.Git(rushConfiguration).getGitPathOrThrow();
        this._repoRoot = _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_4__.Path.convertToSlashes((0,_rushstack_package_deps_hash__WEBPACK_IMPORTED_MODULE_3__.getRepoRoot)(rushConfiguration.rushJsonFolder, gitPath));
    ...
    async waitForChange(onWatchingFiles) {
        ...
        const repoRoot = _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_4__.Path.convertToSlashes(this._rushConfiguration.rushJsonFolder);
            ...
            function innerListener(root, event, fileName) {
                try {
                    ...
                    if (!useNativeRecursiveWatch) {
                        ...
                        const normalizedName = decodedName && _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_4__.Path.convertToSlashes(decodedName);
                        const fullName = normalizedName && `${root}/${normalizedName}`;
                        if (fullName && !watchers.has(fullName)) {
                            try {
                                const stat = _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_4__.FileSystem.getStatistics(fullName);
                                if (stat.isDirectory()) {
                                    addWatcher(fullName);
                                }
                            }
        ...
        for (const [watchedPath, watcher] of watchers) {
            closePromises.push((0,events__WEBPACK_IMPORTED_MODULE_2__.once)(watcher, 'close').then(() => {
                watchers.delete(watchedPath);
            }));
            watcher.close();
        }
    ...
    async _computeChanged() {
        const state = new _ProjectChangeAnalyzer__WEBPACK_IMPORTED_MODULE_6__.ProjectChangeAnalyzer(this._rushConfiguration);
