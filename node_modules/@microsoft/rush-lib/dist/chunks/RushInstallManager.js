...
/* harmony export */ });
/* harmony import */ var glob__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! glob */ 54230);
...
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! fs */ 657147);
...
/* harmony import */ var ssri__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ssri */ 976376);
/* harmony import */ var ssri__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(ssri__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _base_BaseInstallManager__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../base/BaseInstallManager */ 876149);
/* harmony import */ var _logic_RushConstants__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../logic/RushConstants */ 951904);
/* harmony import */ var _utilities_Stopwatch__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../utilities/Stopwatch */ 314318);
/* harmony import */ var _utilities_Utilities__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../utilities/Utilities */ 827501);
/* harmony import */ var _api_PackageJsonEditor__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../api/PackageJsonEditor */ 73666);
/* harmony import */ var _DependencySpecifier__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../DependencySpecifier */ 68654);
/* harmony import */ var _InstallHelpers__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./InstallHelpers */ 741340);
/* harmony import */ var _TempProjectHelper__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../TempProjectHelper */ 786497);
/* harmony import */ var _LinkManagerFactory__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../LinkManagerFactory */ 662116);
 ...
 */
class RushInstallManager extends _base_BaseInstallManager__WEBPACK_IMPORTED_MODULE_8__.BaseInstallManager {
    constructor(rushConfiguration, rushGlobalFolder, purgeManager, options) {
        ...
        this._tempProjectHelper = new _TempProjectHelper__WEBPACK_IMPORTED_MODULE_9__.TempProjectHelper(this.rushConfiguration);
    }
    /**
    ...
    async prepareCommonTempAsync(shrinkwrapFile) {
        const stopwatch = _utilities_Stopwatch__WEBPACK_IMPORTED_MODULE_10__.Stopwatch.start();
        // Example: "C:\MyRepo\common\temp\projects"
        const tempProjectsFolder = path__WEBPACK_IMPORTED_MODULE_3__.join(this.rushConfiguration.commonTempFolder, _logic_RushConstants__WEBPACK_IMPORTED_MODULE_11__.RushConstants.rushTempProjectsFolderName);
        console.log('\n' + colors_safe__WEBPACK_IMPORTED_MODULE_1___default().bold('Updating temp projects in ' + tempProjectsFolder));
        _utilities_Utilities__WEBPACK_IMPORTED_MODULE_12__.Utilities.createFolderWithRetry(tempProjectsFolder);
        ...
        if (!shrinkwrapFile) {
            ...
            console.log();
            console.log(colors_safe__WEBPACK_IMPORTED_MODULE_1___default().red('The shrinkwrap file had previously been updated to support workspaces. Run "rush update --full" ' +
        ...
        if (shrinkwrapFile) {
            ...
            allExplicitPreferredVersions.forEach((version, dependency) => {
                const dependencySpecifier = new _DependencySpecifier__WEBPACK_IMPORTED_MODULE_13__.DependencySpecifier(dependency, version);
                if (!shrinkwrapFile.hasCompatibleTopLevelDependency(dependencySpecifier)) {
                    shrinkwrapWarnings.push(`Missing dependency "${dependency}" (${version}) required by the preferred versions from ` +
                        _logic_RushConstants__WEBPACK_IMPORTED_MODULE_11__.RushConstants.commonVersionsFilename);
                    shrinkwrapIsUpToDate = false;
                }
            });
        ...
        _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.Sort.sortBy(sortedRushProjects, (x) => x.tempProjectName);
        for (const rushProject of sortedRushProjects) {
            ...
            commonDependencies.set(rushProject.tempProjectName, `file:./${_logic_RushConstants__WEBPACK_IMPORTED_MODULE_11__.RushConstants.rushTempProjectsFolderName}/${rushProject.unscopedTempProjectName}.tgz`);
            ...
            for (const dependency of packageJson.dependencyList) {
                ...
                if (dependency.dependencyType === _api_PackageJsonEditor__WEBPACK_IMPORTED_MODULE_14__.DependencyType.Optional) {
            ...
            _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.Sort.sortMapKeys(tempDependencies);
            for (const [packageName, packageVersion] of tempDependencies.entries()) {
                const dependencySpecifier = new _DependencySpecifier__WEBPACK_IMPORTED_MODULE_13__.DependencySpecifier(packageName, packageVersion);
                ...
                if (localProject) {
                    ...
                    if (!rushProject.decoupledLocalDependencies.has(packageName)) {
                        ...
                        if (semver__WEBPACK_IMPORTED_MODULE_4__.satisfies(localProjectVersion, packageVersion)) {
            ...
            const tempPackageJsonFilename = path__WEBPACK_IMPORTED_MODULE_3__.join(tempProjectFolder, _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.FileConstants.PackageJson);
            ...
            try {
                ...
                if (_rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.FileSystem.exists(tarballFile) && _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.FileSystem.exists(tempPackageJsonFilename)) {
                    // compare the extracted package.json with the one we are about to write
                    const oldBuffer = _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.FileSystem.readFileToBuffer(tempPackageJsonFilename);
                    const newBuffer = Buffer.from(_rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.JsonFile.stringify(tempPackageJson));
            ...
            if (shouldOverwrite) {
                try {
                    ...
                    _utilities_Utilities__WEBPACK_IMPORTED_MODULE_12__.Utilities.createFolderWithRetry(tempProjectFolder);
                    ...
                    _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.FileSystem.deleteFile(tarballFile);
                    _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.FileSystem.deleteFile(tempPackageJsonFilename);
                    // write the expected package.json file into the zip staging folder
                    _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.JsonFile.save(tempPackageJson, tempPackageJsonFilename);
                    ...
                    console.log(colors_safe__WEBPACK_IMPORTED_MODULE_1___default().yellow(error));
            ...
            if (packageJson.saveIfModified()) {
                console.log(colors_safe__WEBPACK_IMPORTED_MODULE_1___default().yellow(`"${rushProject.packageName}" depends on one or more local packages which used "workspace:" ` +
        ...
        if (this.rushConfiguration.packageManager === 'pnpm') {
            const workspaceFilePath = path__WEBPACK_IMPORTED_MODULE_3__.join(this.rushConfiguration.commonTempFolder, 'pnpm-workspace.yaml');
            try {
                await _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.FileSystem.deleteFileAsync(workspaceFilePath);
            }
            catch (e) {
                if (!_rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.FileSystem.isNotExistError(e)) {
                    throw e;
                }
            }
        }
        // Write the common package.json
        _InstallHelpers__WEBPACK_IMPORTED_MODULE_15__.InstallHelpers.generateCommonPackageJson(this.rushConfiguration, commonDependencies);
        stopwatch.stop();
        console.log(`Finished creating temporary modules (${stopwatch.toString()})`);
        return { shrinkwrapIsUpToDate, shrinkwrapWarnings };
    }
    _revertWorkspaceNotation(dependency) {
        const specifier = new _DependencySpecifier__WEBPACK_IMPORTED_MODULE_13__.DependencySpecifier(dependency.name, dependency.version);
        if (specifier.specifierType !== _DependencySpecifier__WEBPACK_IMPORTED_MODULE_13__.DependencySpecifierType.Workspace) {
            return false;
        }
        ...
        if (specifier.versionSpecifier === '*') {
            ...
            if (!localProject) {
                throw new _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.InternalError(`Could not find local project with package name ${specifier.packageName}`);
            }
    ...
    async _validateRushProjectTarballIntegrityAsync(shrinkwrapFile, rushProject) {
        if (shrinkwrapFile) {
            ...
            const newIntegrity = (await ssri__WEBPACK_IMPORTED_MODULE_5__.fromStream(fs__WEBPACK_IMPORTED_MODULE_2__.createReadStream(this._tempProjectHelper.getTarballFilePath(rushProject)))).toString();
    ...
    canSkipInstall(lastModifiedDate) {
        ...
        return _utilities_Utilities__WEBPACK_IMPORTED_MODULE_12__.Utilities.isFileTimestampCurrent(lastModifiedDate, potentiallyChangedFiles);
    }
    /**
    ...
    async installAsync(cleanInstall) {
        ...
        const packageManagerEnv = _InstallHelpers__WEBPACK_IMPORTED_MODULE_15__.InstallHelpers.getPackageManagerEnvironment(this.rushConfiguration, this.options);
        const commonNodeModulesFolder = path__WEBPACK_IMPORTED_MODULE_3__.join(this.rushConfiguration.commonTempFolder, _logic_RushConstants__WEBPACK_IMPORTED_MODULE_11__.RushConstants.nodeModulesFolderName);
        // Is there an existing "node_modules" folder to consider?
        if (_rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.FileSystem.exists(commonNodeModulesFolder)) {
            ...
            if (cleanInstall) {
                ...
                _utilities_Utilities__WEBPACK_IMPORTED_MODULE_12__.Utilities.createFolderWithRetry(commonNodeModulesFolder);
            }
            else {
                ...
                if (this.rushConfiguration.packageManager === 'npm') {
                    ...
                    _utilities_Utilities__WEBPACK_IMPORTED_MODULE_12__.Utilities.executeCommandWithRetry({
                    ...
                    const pathToDeleteWithoutStar = path__WEBPACK_IMPORTED_MODULE_3__.join(commonNodeModulesFolder, _logic_RushConstants__WEBPACK_IMPORTED_MODULE_11__.RushConstants.rushTempNpmScope);
                    console.log(`Deleting ${pathToDeleteWithoutStar}\\*`);
                    // Glob can't handle Windows paths
                    const normalizedpathToDeleteWithoutStar = _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.Text.replaceAll(pathToDeleteWithoutStar, '\\', '/');
                    // Example: "C:/MyRepo/common/temp/node_modules/@rush-temp/*"
                    for (const tempModulePath of glob__WEBPACK_IMPORTED_MODULE_0__.sync(globEscape(normalizedpathToDeleteWithoutStar) + '/*')) {
                        // We could potentially use AsyncRecycler here, but in practice these folders tend
                        // to be very small
                        _utilities_Utilities__WEBPACK_IMPORTED_MODULE_12__.Utilities.dangerouslyDeletePath(tempModulePath);
                    }
                }
            }
        }
        if (this.rushConfiguration.packageManager === 'yarn') {
            ...
            const yarnRushTempCacheFolder = path__WEBPACK_IMPORTED_MODULE_3__.join(this.rushConfiguration.yarnCacheFolder, 'v2', 'npm-@rush-temp');
            if (_rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.FileSystem.exists(yarnRushTempCacheFolder)) {
                console.log('Deleting ' + yarnRushTempCacheFolder);
                _utilities_Utilities__WEBPACK_IMPORTED_MODULE_12__.Utilities.dangerouslyDeletePath(yarnRushTempCacheFolder);
            }
        }
        ...
        console.log('\n' +
            colors_safe__WEBPACK_IMPORTED_MODULE_1___default().bold(`Running "${this.rushConfiguration.packageManager} install" in` +
        ...
        if (this.options.debug || this.options.collectLogFile || this.options.networkConcurrency) {
            console.log('\n' +
                colors_safe__WEBPACK_IMPORTED_MODULE_1___default().green('Invoking package manager: ') +
                _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.FileSystem.getRealPath(packageManagerFilename) +
                ' ' +
                installArgs.join(' ') +
                '\n');
        }
        try {
            _utilities_Utilities__WEBPACK_IMPORTED_MODULE_12__.Utilities.executeCommandWithRetry({
                ...
                if (this.rushConfiguration.packageManager === 'pnpm') {
                    console.log(colors_safe__WEBPACK_IMPORTED_MODULE_1___default().yellow(`Deleting the "node_modules" folder`));
                    this.installRecycler.moveFolder(commonNodeModulesFolder);
            ...
            if (this.rushConfiguration.packageManager === 'pnpm' &&
                ...
                console.log(colors_safe__WEBPACK_IMPORTED_MODULE_1___default().yellow(`Deleting the "pnpm-store" folder`));
                this.installRecycler.moveFolder(this.rushConfiguration.pnpmOptions.pnpmStorePath);
            }
            throw error;
        }
        if (this.rushConfiguration.packageManager === 'npm') {
            console.log('\n' + colors_safe__WEBPACK_IMPORTED_MODULE_1___default().bold('Running "npm shrinkwrap"...'));
    ...
    async postInstallAsync() {
        if (!this.options.noLink) {
            const linkManager = _LinkManagerFactory__WEBPACK_IMPORTED_MODULE_16__.LinkManagerFactory.getLinkManager(this.rushConfiguration);
            await linkManager.createSymlinksForProjects(false);
        }
        else {
            console.log('\n' + colors_safe__WEBPACK_IMPORTED_MODULE_1___default().yellow('Since "--no-link" was specified, you will need to run "rush link" manually.'));
        }
    }
    /**
    ...
    _fixupNpm5Regression() {
        const pathToDeleteWithoutStar = path__WEBPACK_IMPORTED_MODULE_3__.join(this.rushConfiguration.commonTempFolder, 'node_modules', _logic_RushConstants__WEBPACK_IMPORTED_MODULE_11__.RushConstants.rushTempNpmScope);
        // Glob can't handle Windows paths
        const normalizedPathToDeleteWithoutStar = _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.Text.replaceAll(pathToDeleteWithoutStar, '\\', '/');
        let anyChanges = false;
        // Example: "C:/MyRepo/common/temp/node_modules/@rush-temp/*/package.json"
        for (const packageJsonPath of glob__WEBPACK_IMPORTED_MODULE_0__.sync(globEscape(normalizedPathToDeleteWithoutStar) + '/*/package.json')) {
            // Example: "C:/MyRepo/common/temp/node_modules/@rush-temp/example/package.json"
            const packageJsonObject = _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.JsonFile.load(packageJsonPath);
            // The temp projects always use "0.0.0" as their version
            packageJsonObject.version = '0.0.0';
            if (_rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_6__.JsonFile.save(packageJsonObject, packageJsonPath, { onlyIfChanged: true })) {
                anyChanges = true;
            }
        }
        if (anyChanges) {
            console.log('\n' + colors_safe__WEBPACK_IMPORTED_MODULE_1___default().yellow(_rushstack_terminal__WEBPACK_IMPORTED_MODULE_7__.PrintUtilities.wrapWords(`Applied workaround for NPM 5 bug`)) + '\n');
        }
    }
    /**
    ...
    _findMissingTempProjects(shrinkwrapFile) {
        ...
        for (const rushProject of this.rushConfiguration.projects) {
            if (!tempProjectNames.has(rushProject.tempProjectName)) {
                console.log('\n' +
                    colors_safe__WEBPACK_IMPORTED_MODULE_1___default().yellow(_rushstack_terminal__WEBPACK_IMPORTED_MODULE_7__.PrintUtilities.wrapWords(`Your ${this.rushConfiguration.shrinkwrapFilePhrase} is missing the project "${rushProject.packageName}".`)) +
                    '\n');
