...
const TIMELINE_CHART_SYMBOLS = {
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.Ready]: '?',
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.Executing]: '?',
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.Success]: '#',
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.SuccessWithWarning]: '!',
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.Failure]: '!',
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.Blocked]: '.',
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.Skipped]: '%',
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.FromCache]: '%',
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.NoOp]: '%'
};
/**
 * Timeline - colorizer for each operation status
 */
const TIMELINE_CHART_COLORIZER = {
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.Ready]: (colors_safe__WEBPACK_IMPORTED_MODULE_1___default().yellow),
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.Executing]: (colors_safe__WEBPACK_IMPORTED_MODULE_1___default().yellow),
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.Success]: (colors_safe__WEBPACK_IMPORTED_MODULE_1___default().green),
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.SuccessWithWarning]: (colors_safe__WEBPACK_IMPORTED_MODULE_1___default().yellow),
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.Failure]: (colors_safe__WEBPACK_IMPORTED_MODULE_1___default().red),
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.Blocked]: (colors_safe__WEBPACK_IMPORTED_MODULE_1___default().red),
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.Skipped]: (colors_safe__WEBPACK_IMPORTED_MODULE_1___default().green),
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.FromCache]: (colors_safe__WEBPACK_IMPORTED_MODULE_1___default().green),
    [_OperationStatus__WEBPACK_IMPORTED_MODULE_2__.OperationStatus.NoOp]: (colors_safe__WEBPACK_IMPORTED_MODULE_1___default().gray)
};
/**
...
function _printTimeline(terminal, result) {
    ...
    for (const { startTime, endTime, durationString, name, status } of data) {
        ...
        const chart = colors_safe__WEBPACK_IMPORTED_MODULE_1___default().gray('-'.repeat(startIdx)) +
            TIMELINE_CHART_COLORIZER[status](TIMELINE_CHART_SYMBOLS[status].repeat(length)) +
            colors_safe__WEBPACK_IMPORTED_MODULE_1___default().gray('-'.repeat(chartWidth - endIdx));
        terminal.writeLine(`${colors_safe__WEBPACK_IMPORTED_MODULE_1___default().cyan(name.padStart(longestNameLength))} ${chart} ${colors_safe__WEBPACK_IMPORTED_MODULE_1___default().white(durationString.padStart(longestDurationLength) + 's')}`);
    }
    terminal.writeLine('='.repeat(maxWidth));
    //
    ...
    if (durationByPhase.size > 0) {
        ...
        for (const [phase, duration] of durationByPhase.entries()) {
            terminal.writeLine(`  ${colors_safe__WEBPACK_IMPORTED_MODULE_1___default().cyan(phase.name.padStart(maxPhaseName))} ${duration.toFixed(1)}s`);
        }
    }
    terminal.writeLine('');
}
