...
/* harmony import */ var dependency_path__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! dependency-path */ 824957);
/* harmony import */ var dependency_path__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(dependency_path__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var colors_safe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! colors/safe */ 623211);
...
/* harmony import */ var _base_BaseLinkManager__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../base/BaseLinkManager */ 826636);
/* harmony import */ var _base_BasePackage__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../base/BasePackage */ 22978);
/* harmony import */ var _logic_RushConstants__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../logic/RushConstants */ 951904);
/* harmony import */ var _PnpmShrinkwrapFile__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./PnpmShrinkwrapFile */ 930997);
// Copyright (c) Microsoft Corporation. All rights reserved. Licensed under the MIT license.
// See LICENSE in the project root for license information.
...
const DEBUG = false;
class PnpmLinkManager extends _base_BaseLinkManager__WEBPACK_IMPORTED_MODULE_8__.BaseLinkManager {
    constructor() {
        super(...arguments);
    ...
    async createSymlinksForProjects(force) {
        ...
        if (useWorkspaces) {
            console.log(colors_safe__WEBPACK_IMPORTED_MODULE_6___default().red('Linking is not supported when using workspaces. Run "rush install" or "rush update" ' +
                'to restore project node_modules folders.'));
            throw new _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_7__.AlreadyReportedError();
        }
    ...
    async _linkProjects() {
        if (this._rushConfiguration.projects.length > 0) {
            ...
            const pnpmShrinkwrapFile = _PnpmShrinkwrapFile__WEBPACK_IMPORTED_MODULE_9__.PnpmShrinkwrapFile.loadFromFile(this._rushConfiguration.tempShrinkwrapFilename);
            if (!pnpmShrinkwrapFile) {
                throw new _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_7__.InternalError(`Cannot load shrinkwrap at "${this._rushConfiguration.tempShrinkwrapFilename}"`);
            }
            for (const rushProject of this._rushConfiguration.projects) {
    ...
    async _linkProject(project, pnpmShrinkwrapFile) {
        ...
        const unscopedTempProjectName = this._rushConfiguration.packageNameParser.getUnscopedName(project.tempProjectName);
        // Example: "C:\MyRepo\common\temp\projects\project1
        const extractedFolder = path__WEBPACK_IMPORTED_MODULE_0__.join(this._rushConfiguration.commonTempFolder, _logic_RushConstants__WEBPACK_IMPORTED_MODULE_10__.RushConstants.rushTempProjectsFolderName, unscopedTempProjectName);
        // Example: "C:\MyRepo\common\temp\projects\project1\package.json"
        const packageJsonFilename = path__WEBPACK_IMPORTED_MODULE_0__.join(extractedFolder, _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_7__.FileConstants.PackageJson);
        // Example: "C:\MyRepo\common\temp\node_modules\@rush-temp\project1"
        const installFolderName = path__WEBPACK_IMPORTED_MODULE_0__.join(this._rushConfiguration.commonTempFolder, _logic_RushConstants__WEBPACK_IMPORTED_MODULE_10__.RushConstants.nodeModulesFolderName, _logic_RushConstants__WEBPACK_IMPORTED_MODULE_10__.RushConstants.rushTempNpmScope, unscopedTempProjectName);
        const commonPackage = _base_BasePackage__WEBPACK_IMPORTED_MODULE_11__.BasePackage.createVirtualTempPackage(packageJsonFilename, installFolderName);
        const localPackage = _base_BasePackage__WEBPACK_IMPORTED_MODULE_11__.BasePackage.createLinkedPackage(project.packageName, commonPackage.version, project.projectFolder);
        ...
        for (const dependencyName of Object.keys(commonPackage.packageJson.rushDependencies || {})) {
            ...
            if (matchedRushPackage) {
                ...
                const newLocalPackage = _base_BasePackage__WEBPACK_IMPORTED_MODULE_11__.BasePackage.createLinkedPackage(dependencyName, matchedVersion, newLocalFolderPath);
                newLocalPackage.symlinkTargetFolderPath = matchedRushPackage.projectFolder;
                localPackage.children.push(newLocalPackage);
            }
            else {
                throw new _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_7__.InternalError(`Cannot find dependency "${dependencyName}" for "${project.packageName}" in the Rush configuration`);
            }
        }
        ...
        if (!tarballEntry) {
            throw new _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_7__.InternalError(`Cannot find tarball path for "${project.tempProjectName}" in shrinkwrap.`);
        }
        ...
        const pathToLocalInstallation = this._getPathToLocalInstallation(tarballEntry, absolutePathToTgzFile, folderNameSuffix);
        ...
        if (!parentShrinkwrapEntry) {
            throw new _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_7__.InternalError(`Cannot find shrinkwrap entry using dependency key for temp project: ${project.tempProjectName}`);
        }
        ...
        await _pnpm_link_bins__WEBPACK_IMPORTED_MODULE_3___default()(projectFolder, projectBinFolder, {
            warn: (msg) => console.warn(colors_safe__WEBPACK_IMPORTED_MODULE_6___default().yellow(msg))
        });
    }
    _getPathToLocalInstallation(tarballEntry, absolutePathToTgzFile, folderSuffix) {
        if (this._pnpmVersion.major === 6) {
            ...
            const escapedLocalPath = _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_7__.Path.convertToSlashes(absolutePathToTgzFile).replace(specialCharRegex, '+');
            ...
            return path__WEBPACK_IMPORTED_MODULE_0__.join(this._rushConfiguration.commonTempFolder, _logic_RushConstants__WEBPACK_IMPORTED_MODULE_10__.RushConstants.nodeModulesFolderName, '.pnpm', folderName, _logic_RushConstants__WEBPACK_IMPORTED_MODULE_10__.RushConstants.nodeModulesFolderName);
        }
            ...
            const escapedLocalPath = (0,dependency_path__WEBPACK_IMPORTED_MODULE_5__.depPathToFilename)(tarballEntry);
            ...
            const folderNameInLocalInstallationRoot = strict_uri_encode__WEBPACK_IMPORTED_MODULE_2___default()(_rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_7__.Path.convertToSlashes(absolutePathToTgzFile)) + folderSuffix;
            // See https://github.com/pnpm/pnpm/releases/tag/v4.0.0
            return path__WEBPACK_IMPORTED_MODULE_0__.join(this._rushConfiguration.commonTempFolder, _logic_RushConstants__WEBPACK_IMPORTED_MODULE_10__.RushConstants.nodeModulesFolderName, '.pnpm', 'local', folderNameInLocalInstallationRoot, _logic_RushConstants__WEBPACK_IMPORTED_MODULE_10__.RushConstants.nodeModulesFolderName);
        }
    }
    _createLocalPackageForDependency(project, parentShrinkwrapEntry, localPackage, pathToLocalInstallation, dependencyName, isOptional = false) {
        ...
        if (!_rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_7__.FileSystem.exists(dependencyLocalInstallationSymlink)) {
            // if this occurs, it is a bug in Rush algorithm or unexpected PNPM behavior
            throw new _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_7__.InternalError(`Cannot find installed dependency "${dependencyName}" in "${pathToLocalInstallation}"`);
        }
        if (!_rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_7__.FileSystem.getLinkStatistics(dependencyLocalInstallationSymlink).isSymbolicLink()) {
            // if this occurs, it is a bug in Rush algorithm or unexpected PNPM behavior
            throw new _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_7__.InternalError(`Dependency "${dependencyName}" is not a symlink in "${pathToLocalInstallation}`);
        }
        ...
        if (!version) {
            if (!isOptional) {
                throw new _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_7__.InternalError(`Cannot find shrinkwrap entry dependency "${dependencyName}" for temp project: ` +
                    `${project.tempProjectName}`);
            }
            return;
        }
        const newLocalFolderPath = path__WEBPACK_IMPORTED_MODULE_0__.join(localPackage.folderPath, 'node_modules', dependencyName);
        const newLocalPackage = _base_BasePackage__WEBPACK_IMPORTED_MODULE_11__.BasePackage.createLinkedPackage(dependencyName, version, newLocalFolderPath);
        ...
        newLocalPackage.symlinkTargetFolderPath = _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_7__.FileSystem.getRealPath(dependencyLocalInstallationSymlink);
