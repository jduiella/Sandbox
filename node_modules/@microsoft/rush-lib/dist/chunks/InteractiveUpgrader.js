...
const _ = _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_3__.Import.lazy('lodash', require);
...
function createChoices(packages, options) {
    ...
    const choicesWithTableFormatting = _.map(choices, (choice, i) => {
...
/* harmony import */ var inquirer_lib_prompts_base__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! inquirer/lib/prompts/base */ 183798);
/* harmony import */ var inquirer_lib_prompts_base__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(inquirer_lib_prompts_base__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var inquirer_lib_utils_events__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! inquirer/lib/utils/events */ 163626);
/* harmony import */ var inquirer_lib_utils_events__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(inquirer_lib_utils_events__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var inquirer_lib_utils_paginator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! inquirer/lib/utils/paginator */ 672982);
/* harmony import */ var inquirer_lib_utils_paginator__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(inquirer_lib_utils_paginator__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var figures__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! figures */ 666016);
/* harmony import */ var figures__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(figures__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs/operators */ 315863);
...
const _ = _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_1__.Import.lazy('lodash', require);
class SearchListPrompt extends (inquirer_lib_prompts_base__WEBPACK_IMPORTED_MODULE_2___default()) {
    constructor(question, readline, answers) {
        ...
        if (_.isNumber(this.opt.default) &&
            this.opt.default >= 0 &&
        ...
        this._paginator = new (inquirer_lib_utils_paginator__WEBPACK_IMPORTED_MODULE_4___default())(this.screen);
    }
    _run(callback) {
        this.done = callback;
        // eslint-disable-next-line @typescript-eslint/typedef
        const events = inquirer_lib_utils_events__WEBPACK_IMPORTED_MODULE_3___default()(this.rl);
        // eslint-disable-next-line @typescript-eslint/typedef
        const validation = this.handleSubmitEvents(events.line.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.map)(this._getCurrentValue.bind(this))));
        ...
        void events.numberKey
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.takeUntil)(events.line))
            .forEach(this._onNumberKey.bind(this));
        // eslint-disable-next-line no-void
        void events.keypress
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.takeUntil)(validation.success))
...
function listRender(choices, pointer) {
    ...
    choices.forEach((choice, i) => {
        ...
        if (!choice.disabled) {
            ...
            if (i === pointer) {
                output += colors_safe__WEBPACK_IMPORTED_MODULE_0___default().cyan((figures__WEBPACK_IMPORTED_MODULE_5___default().pointer) + line);
            }
            else {
                output += ' ' + line;
            }
