...
/* harmony import */ var _api_Rush__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../api/Rush */ 465002);
...
/* harmony import */ var _utilities_WebClient__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../utilities/WebClient */ 618105);
/* harmony import */ var _setup_SetupPackageRegistry__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../setup/SetupPackageRegistry */ 555992);
...
class BaseInstallManager {
    ...
    async prepareAsync() {
        // Check the policies
        _policy_PolicyValidator__WEBPACK_IMPORTED_MODULE_11__.PolicyValidator.validatePolicy(this.rushConfiguration, this.options);
        ...
        if (_rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_5__.FileSystem.exists(hookSource) && hookDestination) {
            ...
            if (hookFilenames.length > 0) {
                ...
                for (const filename of filteredHookFilenames) {
                    ...
                    const hookFileContent = _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_5__.FileSystem.readFile(path__WEBPACK_IMPORTED_MODULE_2__.join(hookSource, filename));
    ...
    async _checkIfReleaseIsPublished() {
        const lastCheckFile = path__WEBPACK_IMPORTED_MODULE_2__.join(this.rushGlobalFolder.nodeSpecificPath, 'rush-' + _api_Rush__WEBPACK_IMPORTED_MODULE_18__.Rush.version, 'last-check.flag');
    ...
    async _queryIfReleaseIsPublishedAsync(registryUrl) {
        ...
        const webClient = new _utilities_WebClient__WEBPACK_IMPORTED_MODULE_19__.WebClient();
        ...
        let url;
        try {
            if (!data.versions[_api_Rush__WEBPACK_IMPORTED_MODULE_18__.Rush.version]) {
                // Version was not published
                return false;
            }
            url = data.versions[_api_Rush__WEBPACK_IMPORTED_MODULE_18__.Rush.version].dist.tarball;
            if (!url) {
    ...
    async validateNpmSetup() {
        ...
        if (!this.options.bypassPolicy) {
            const setupPackageRegistry = new _setup_SetupPackageRegistry__WEBPACK_IMPORTED_MODULE_20__.SetupPackageRegistry({
            ...
            if (!valid) {
                ...
                console.error();
                console.error(colors_safe__WEBPACK_IMPORTED_MODULE_0___default().bold('==> Please run "rush setup" to update your NPM token.  (Or append "--bypass-policy" to proceed anyway.)'));
                throw new _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_5__.AlreadyReportedError();
            }
        }
...
/* harmony import */ var _api_LastLinkFlag__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../api/LastLinkFlag */ 986208);
...
/* harmony import */ var _ShrinkwrapFileFactory__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../ShrinkwrapFileFactory */ 819779);
/* harmony import */ var _base_BaseProjectShrinkwrapFile__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../base/BaseProjectShrinkwrapFile */ 894306);
// Copyright (c) Microsoft Corporation. All rights reserved. Licensed under the MIT license.
// See LICENSE in the project root for license information.
...
class WorkspaceInstallManager extends _base_BaseInstallManager__WEBPACK_IMPORTED_MODULE_4__.BaseInstallManager {
    ...
    async postInstallAsync() {
        ...
        const tempShrinkwrapFile = _ShrinkwrapFileFactory__WEBPACK_IMPORTED_MODULE_12__.ShrinkwrapFileFactory.getShrinkwrapFile(this.rushConfiguration.packageManager, this.rushConfiguration.pnpmOptions, this.rushConfiguration.tempShrinkwrapFilename);
        if (tempShrinkwrapFile) {
            ...
            await _rushstack_node_core_library__WEBPACK_IMPORTED_MODULE_3__.Async.forEachAsync(this.rushConfiguration.projects, async (project) => {
                await _base_BaseProjectShrinkwrapFile__WEBPACK_IMPORTED_MODULE_13__.BaseProjectShrinkwrapFile.saveEmptyProjectShrinkwrapFileAsync(project);
            }, { concurrency: 10 });
        }
        else {
        ...
        // TODO: Remove when "rush link" and "rush unlink" are deprecated
        _api_LastLinkFlag__WEBPACK_IMPORTED_MODULE_14__.LastLinkFlagFactory.getCommonTempFlag(this.rushConfiguration).create();
    }
    /**
     * Used when invoking the NPM tool.  Appends the common configuration options
     * to the command-line.
