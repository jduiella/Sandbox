    ...
    apply(heftSession, heftConfiguration) {
        heftSession.registerAction({
            ...
            parameters: {
                ...
                prettyPrintXml: {
                    kind: 'flag',
                    parameterLongName: '--pretty-print-xml',
                    description: 'If specified, pretty print the XML files.'
                },
                noSpppkg: {
                    kind: 'flag',
                    parameterLongName: '--no-spppkg',
            ...
            callback: async (options) => {
                ...
                await solutionPackager.packageSolutionAsync(options.production, options.prettyPrintXml, options.noSpppkg);
            }
        });
