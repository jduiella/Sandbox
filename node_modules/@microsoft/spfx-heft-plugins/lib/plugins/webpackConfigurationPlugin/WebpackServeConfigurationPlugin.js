            ...
            if (build.properties.serveMode) {
                build.hooks.bundle.tap(PluginNames.SpfxWebpackServePlugin, (bundle) => {
                    bundle.hooks.configureWebpack.tapPromise(PluginNames.SpfxWebpackServePlugin, async (untypedConfig) => {
                        ...
                        if (((_c = serveConfig.initialPage) === null || _c === void 0 ? void 0 : _c.includes(TENANT_DOMAIN_PLACEHOLDER)) &&
                            process.env.SPFX_SERVE_TENANT_DOMAIN) {
                            serveConfig.initialPage = serveConfig.initialPage.replace(TENANT_DOMAIN_PLACEHOLDER, process.env.SPFX_SERVE_TENANT_DOMAIN);
                        }
